...
\begin{slide}
\begin{center}
Widerlegungs-Vollständigkeit der Schnitt-Regel
\end{center}
\vspace*{0.5cm}
...
\rule{17cm}{1mm}
Widerlegungs-Vollständigkeit  \hspace*{\fill} Seite \arabic{mypage}
\end{slide}
...
\footnotesize
\begin{Satz}[Widerlegungs-Vollständigkeits-Satz] \hspace*{\fill} \\[-0.9cm]
  \begin{tabbing}
  \textbf{Vor.:} \= $\{k_1, \cdots, k_n \}$: \= Menge von Klauseln \\[0.3cm]
                 \> $k$:                     \> Klausel \\[0.3cm]
  \textbf{Beh.:} \> 
...
\textbf{Algorithmus}
\begin{enumerate}
\item Führe alle mögl. Schnitte mit Unit-Klauseln durch.
\item Vereinfache mit Subsumption. 
\item Falls $K$ trivial: fertig!
\item Wähle aussagenlogische Variable $p$ aus $K$.
      \begin{enumerate}
      \item Suche rekursiv Lösung für $\mathcal{I}$ für $K \cup \biggl\{\{p\}\biggr\}$.

      \item Falls (a) erfolglos ist:
      
            Suche rekursiv Lösung für $\mathcal{I}$ für $K \cup \biggl\{\{\neg p\}\biggr\}$
      \end{enumerate}
\end{enumerate}
...
\footnotesize
Können 8 Damen so auf einem Schach--Brett
