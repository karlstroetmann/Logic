...
\item
  $K$ erfüllbar \quad g.d.w. 

  $K \cup \biggl\{\{p\}\biggr\}$ erfüllbar \quad oder \quad
  $K \cup \biggl\{\{\neg p\}\biggr\}$ erfüllbar  
...
\textbf{Algorithmus}
\begin{enumerate}
\item Führe alle möglichen Unit-Schnitte aus.
\item Führe alle möglichen Unit-Subsumptionen aus.
\item Falls $K$ trivial:  fertig!
\item Sonst: Wähle aussagenlogische Variable $p$ aus $K$.
      \begin{enumerate}
...
Zweckmäßig:  $\textsl{unitCut}()$ und $\textsl{subsume}()$ zusammen fassen
\\[0.4cm]
