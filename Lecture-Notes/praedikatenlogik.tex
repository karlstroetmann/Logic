...
\begin{Definition}[äquivalent]
  Zwei Formeln $F$ und $G$ heißen {\blue{äquivalent}} g.d.w. gilt \\[0.2cm]
...
\item In Zeile 6 fassen wir die einzelnen Interpretationen zu der Relation $J$
      ...
      Da wir später den in \textsc{SetlX} eingebauten Parser verwenden wollen, m\"ussen wir die
      pr\"adikatenlogischen Formeln als
      Terme darstellen.  Dazu stellen wir den Operator ``\texttt{*}'' durch den Funktor ``\texttt{@@@product}''
      dar und f\"ur das Prädikats-Zeichen ``\texttt{=}'' verwenden wir den Funktor ``\texttt{@@@equals}'',
...
Im nächsten Abschnitt gehen wir daran, den fr\"uher  erwähnten Kalkül $\vdash$ f\"ur die
...
\noindent
Substitutionen werden für uns dadurch interessant, dass wir sie auf Terme {\blue{anwenden}}
...
\item Die 2.~oder die 6.~Regel ist anwendbar.  Dann hat das Gleichungs-System $E$ hat
      \underline{\color{red}keine} Lösung und als Ergebnis der Unifikation wird $\Omega$ zur\"uck gegeben.
