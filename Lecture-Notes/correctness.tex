...
root of its argument \texttt{a} bit by bit starting at the most significant bit.  Let us denote the
...
\\[0.2cm]
\hspace*{1.3cm}
$\ds\left(\ds\sum\limits_{i=32-(n-1)}^{31} b_i \cdot 2^i + 2^{32-n}\right)^2 \leq a$.
\\[0.2cm]
