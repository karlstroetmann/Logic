...
In this chapter we will show two different methods that can be used to prove the correctness of \textsl{Python}
function.
\begin{enumerate}[(a)]
...
\exerciseEng
Prove that the function \mytt{div\_mod} that is shown in Figure \ref{fig:gcd} satisfies the specification
\\[0.2cm]
\hspace*{1.3cm}
$\mytt{div\_mod}(m, n) = (q, r) \rangle \rightarrow m = q \cdot n + r \;\wedge\; r < n$. \eox
