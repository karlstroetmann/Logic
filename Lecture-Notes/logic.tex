...
\title{\epsfig{file=dhbw-logo.eps, scale=1.5}  \\[0.2cm]
...
in the file \href{https://github.com/karlstroetmann/Logic/blob/master/Lecture-Notes-Python/logic.pdf}{\texttt{logic.pdf}}.
