...
\title{\vspace*{-2.5cm}
  \epsfig{file=dhbw-logo.eps, scale=1.0}  \\[0.3cm]
       ...
       An Introduction to Logic via \textsl{TypeScript} \\[0.3cm]
      --- Spring 2026 ---     \\[0.3cm]
...
are found in the directory \href{https://github.com/karlstroetmann/Logic/blob/master/TypeScript}{\texttt{TypeScript}}.
As I am currently switching these lecture notes from Python to TypeScript, these lecture notes will be revised
frequently.  To automatically update your own copy the lecture notes,  you can install
