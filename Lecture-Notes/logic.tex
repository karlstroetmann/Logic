...
\title{\epsfig{file=dhbw-logo.eps, scale=2.0}  \\[0.3cm]
       Theoretical Computer Science \texttt{I}: Logic \\[0.3cm]
      --- Winter 2017 ---     \\[0.3cm]
      DHBW Mannheim}
...
\hspace*{\fill} 
\\[0.2cm]
The \href{https://github.com/karlstroetmann/Logik/blob/master/Lecture-Notes/logic.pdf}{lecture notes} are
