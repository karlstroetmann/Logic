...
Das \blue{Halte-Problem} ist die Frage, ob eine gegebene Funktion für eine bestimmte Eingabe 
\blue{terminiert}.  Bevor wir formal beweisen, dass das Halte-Problem im Allgemeinen \blue{unlösbar} ist, wollen 
...
zeigen wir dann die \blue{Unlösbarkeit} des Halte-Problems. 
...
$(n+1)^2$ eine Primzahl liegt, benutzt die vordefinierte Funktion \texttt{isPrime}, mit der wir für eine
vorgegebene natürliche Zahl $k$ überprüfen können, ob $k$ eine Primzahl ist.
