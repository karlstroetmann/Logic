...
und sagen, dass der Aufruf $f(a_1, \cdots, a_k)$ \colorbox{yellow}{\blue{terminiert}}.
Terminiert der Aufruf $f(a_1, \cdots, a_k)$ nicht, so schreiben wir \\[0.3cm]
\hspace*{1.3cm} $f(a_1, \cdots, a_k) \,\uparrow$ \\[0.3cm]
und sagen, dass der Aufruf $f(a_1, \cdots, a_k)$ \colorbox{yellow}{\blue{divergiert}}.  Diese Notation
