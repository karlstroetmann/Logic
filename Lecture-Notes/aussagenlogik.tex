...
{\color{blue}Aussage-Variablen} ein.  Diese Variablen sind Namen, die für atomare Aussagen stehen.
...
$$
Die Aussagen über dem Bruchstrich bezeichnen wir als die {\color{blue}Prämissen}, die Aussage unter dem Bruchstrich ist die {\color{blue}Konklusion}.
Das Paar, das aus den Prämissen und der Konklusion besteht, bezeichnen wir als {\color{blue}Schluss-Regel}.
...
{\color{blue}Semantik}.  Die \blue{Syntax} gibt an, wie Formeln geschrieben werden.
...
\item $\verum \in \mathcal{F}$ und $\falsum \in \mathcal{F}$.
      ...
      {\color{blue}Verum},
      für $\falsum$ sagen wir  {\color{blue}Falsum}.
...
``\textsl{wenn $\cdots$, dann}'' nur eine \red{Approximation} der umgangssprachlichen Interpretation, die sich für die
