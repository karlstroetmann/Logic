...
\item Die \texttt{while}-Schleife, die in Zeile 23 beginnt, hat die Aufgabe, die Schnitt-Regel
      ...
      abgebrochen werden. 
\item In Zeile 24 wird die Menge \texttt{Derived} als die Menge der Klauseln definiert, die mit Hilfe der
...
\item Falls wir nun in Zeile 29 feststellen, dass wir keine neuen Klauseln hergeleitet haben,
      dann ist die Menge \texttt{Clauses} \blue{saturiert} und wir geben diese Menge in Zeile 30 zurück.
