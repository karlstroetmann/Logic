...
wobei $k$ einen Wert aus der Menge $\{3, \cdots, 15 \}$ annimmt.  Diese Gleichung ist äquivalent zu der Gleichung
\\[0.2cm]
\hspace*{1.3cm}
$c = k - r$.
\\[0.2cm]
Den Wert $k$ geben wir als Argument bei der Prozedur \texttt{atMostOneInUpperDiagonal} mit.  Diese
...
\hspace*{1.3cm} $r - c = k$, \\[0.2cm]
wobei $k$ einen Wert aus der Menge $\{-6, \cdots, 6 \}$ annimmt.  Diese Gleichung ist äquivalent zu der Gleichung
\\[0.2cm]
\hspace*{1.3cm}
$r - k = c$.
\\[0.2cm]
Den Wert $k$ geben wir als Argument bei der Prozedur \texttt{atMostOneInLowerDiagonal} mit.
