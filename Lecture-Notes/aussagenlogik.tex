...
enthalten, verkürzt worden.   Alle anderen Klauseln aus $K$ bleiben unverändert.
...
\mbox{$\bigl\{ C \in K \mid l \not\in C \bigr\}$} die Unit-\-Klausel $\{l\}$ nicht enthält.  Die beiden Mengen
...
Klauseln erfüllt, auf meinem neuen
