...
$\{ p_1, \cdots, p_N \}$
\\[0.2cm]
die Menge aller aussagenlogischen Variablen, die in Klauseln aus $M$ auftreten.  Im folgenden bezeichnen wir
...
Falls $\{l\} \in K$ ist, dann sind die Mengen $K$ und $\mathtt{reduce}(K, l)$ äquivalent.
