...
\item The second argument $I$ is a propositional evaluation.  This evaluation is represented as a set of
  ...
  this type as \texttt{Set}, i.e. we use the following type definition:
  \\[0.2cm]
  \hspace*{1.3cm}
...
\item Since it is rather tedious to write \texttt{new RecursiveSet($\cdots$)} whenever we want to create a new
      set, we define the function \texttt{set}.  We will use this function in all ofthe following programs
