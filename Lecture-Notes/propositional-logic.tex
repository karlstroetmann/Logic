...
If $\verum \el K$, then because of the validity of the equivalence 
...
\begin{Korollar} \label{corollary:knf}
...
This is because the formula $F$ on the right-hand side of the equivalence 
$F \vee (G \wedge H) \leftrightarrow (F \vee G) \wedge (F \vee H)$ occurs twice, while it occurs
only occurs once on the left. 
...
\href{https://github.com/karlstroetmann/Logic/blob/master/Python/Chapter-4/04-CNF.ipynb}{\texttt{04-CNF.ipynb}} 
unter GitHub.
