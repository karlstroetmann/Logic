...
\item Die zweite Zeile enthält eine Zuweisung.  Die Funktion $\textsl{read}()$ gibt
      ...
      \item Alle Variablen müssen in der Sprache \textsc{SetlX} mit einem kleinen
            ...
            Buchstaben beginnen.  Dasselbe gilt für die Namen von Funktionen.
      \end{enumerate}
...
``\texttt{>=}'' und 
``\texttt{<=}''
dieselben Größenvergleiche durch wie in der Sprache \textsl{C}.  Für Mengen
...
Wenn der Bauer den Wolf mit der Ziege allein lässt, dann frißt der Wolf die Ziege und wenn er die
