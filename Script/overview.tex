...
Beispiel: \= $R$ Zuordnung \textsl{Name} zu \textsl{Telefon-Nr.}, \\[0.1cm]
          ...
          \> $Q = \bigl\{ \pair(\mathrm{1234}, \mathrm{Krumme\ Gasse}\;7), \pair(4567, \mathrm{Schloﬂallee}\; 3), \cdots \bigr\}$  \\
...
{\em  Wenn es regnet, ist die Straﬂe naﬂ.  Es regnet nicht.  Also ist die Straﬂe nicht naﬂ.}
\end{minipage}  
\end{center}
