...
\myrule
Prädikatenlogik -- Syntax \hspace*{\fill} Seite \arabic{mypage}
...
\tiny \addtocounter{mypage}{1}
\myrule
Prädikatenlogik   \hspace*{\fill} Seite \arabic{mypage}
\end{slide}
...
\end{enumerate}
Allabschluß: $\forall(h) := \forall x_1, \cdots, x_n:h$ mit $\{x_1,\cdots,x_n\} = \FV(h)$
...
\tiny \addtocounter{mypage}{1}
\myrule
Robinson-Kalkül \hspace*{\fill} Seite \arabic{mypage}
\end{slide}
