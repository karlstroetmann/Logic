...
\subsection{Nachweis der Allgemeing\"{u}ltigkeit durch Ãquivalenz-Umformungen}
...
die Formel mit Hilfe der oben aufgef\"{u}hrten Ãquivalenzen \emph{vereinfachen}.  Wenn es gelingt, eine Formel $F$ unter Verwendung
...
Ãquivalenz-Umformungen einsehen k\"{o}nnen:\\[0.2cm]
\hspace*{1.3cm} 
$ 
\begin{array}[c]{lcr}
...
\begin{Definition}[Literal]
  Eine aussagenlogische Formel $f$ hei\3t \emph{Literal} g.d.w. einer der folgenden F\"{a}lle vorliegt:
  \begin{enumerate}
...
Sp\"{a}ter werden wird noch den Begriff des \emph{Komplements} eines Literals ben\"{o}tigen.
...
\item[I.S.:] $n \mapsto n+1$.
             ...
             \item F\"{u}r alle $i \in \{1,\cdots,n\}$ mit $l_i \in d$ gilt $\I(l_i) = \mathtt{false}$ und es gilt $l_{n+1} = p_{n+1}$.
                   ...
                   zu der Menge Literals hinzugef\"{u}gt.  Nach Definition der Belegung $\I$, 
