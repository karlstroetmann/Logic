...
\begin{center}
Repräsentation des Schach-Bretts als AL-Formel
\end{center}
\vspace*{0.5cm}
...
Allgemeine Invariante für aufsteigende Diagonalen: \\[0.1cm]
\hspace*{1.3cm} $i + j = k$

Allgemeine Invariante für absteigende Diagonalen: \\[0.1cm]
\hspace*{1.3cm} $i - j = k$
