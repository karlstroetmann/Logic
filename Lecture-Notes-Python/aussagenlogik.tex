...
\item Die \texttt{while}-Schleife, die in Zeile 27 beginnt, hat die Aufgabe, die Schnitt-Regel
      ...
      Schleife nur durch die Ausführung einer der beiden \texttt{return}-Befehle (Zeile 33 bzw.~Zeile 36)
      abgebrochen werden. 
...
Zeile 20 spätestens nach $2^{2 \cdot n}$ Iterationen abgebrochen wird.   Tatsächlich ist es in der Praxis so,
dass die \texttt{while} Schleife oft schon nach einer wesentlich geringeren Zahl von Iterationen abgebrochen 
wird. 
...
\item[I.A.:] $n = 1$.
             ...
             \item $D = \{ \neg p \}$.
                   ...
                   wir aus den beiden Klauseln $E$ und $E$ sofort die leere Klausel $\{\}$
                   herleiten und die Prozedur \texttt{findValuation} würde in Zeile 43 den Wert
...
Sie fragen sich vielleicht, wozu wir in der Prozedur \texttt{solve} die Menge
...
Als letztes zeigen wir in Abbildung \ref{fig:solve:queens} die Prozedur
...
\end{Verbatim}
\vspace*{-0.3cm}
\caption{Die Prozedur \texttt{queens}}
