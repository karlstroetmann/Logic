...
\item Eine aussagenlogische Variable $p \in \mathcal{P}$ repräsentieren wir 
      ...
      Form \texttt{\symbol{34}x\symbol{34}} automatisch in den Term \texttt{@variable(\symbol{34}x\symbol{34})}.
...
\item In Zeile 6 betrachten wir den Fall, dass das Argument $f$ eine aussagenlogische
      ...
      Funktion \texttt{varName} extrahiert hierbei aus einem Term der Form \texttt{@variable(\symbol{34}x\symbol{34})} den
      Variablen-Namen \texttt{\symbol{34}x\symbol{34}}.  
