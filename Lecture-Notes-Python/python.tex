...
We have started our lecture with set theory.  In my experience, the notions of
...
theory and logic.  This is the language \href{http://www.python.org}{Python}.
...
theory better by programming in \textsl{Python}.  Furthermore, according to
...
versions of python with different libraries.  In this lecture, we will be using \textsl{Python} version 3.6.
...
\texttt{exit()}
\\[0.2cm]
terminates the interpreter.  In order to print arbitrary results to the screen, we can use the function
...
result of the function \texttt{print} is shown.  
...
\\[0.2cm]
The  \textsl{Python} interpreter can be executed offline to execute programs.
...
\item The first 4 lines define the procedure \texttt{sum}.  In \textsl{Python}, the definition of
      ...
      are enclosed in parentheses. The closing parenthesis is followed by the colon ``\texttt{:}''.
      Contrary to  the programming language \texttt{C}, the body of the procedure is not enclosed curly braces.
      instead, it needs to be indented.
      In general, the body of a procedure consists of a list
...
important difference with respect to \texttt{C}:
      ...
      \begin{minipage}{0.45\linewidth}
        In \textsl{Python}, list indexing starts with the number \texttt{1}!
      \end{minipage}}}}}
      \end{center}      
