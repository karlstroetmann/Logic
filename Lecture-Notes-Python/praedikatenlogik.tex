...
in order to solve a given problem, this problem is \blue{specified} and then this \blue{specification} is
...
\\[0.2cm]
\hspace*{1.3cm}
$\mathcal{I} = \bigl\{ \texttt{Q}_1:4,\, \texttt{Q}_2:8,\, \texttt{Q}_3:1,\, \texttt{Q}_4:2,\, 
...
\vbox{\offinterlineskip
  ...
  \caption{The partial assignment $\bigl\{ \texttt{Q}_1,4, \texttt{Q}_2,8, \texttt{Q}_3,1) \bigr\}$.}
...
can be very important.  The general strategy is that variables that are strongly related to each other should
